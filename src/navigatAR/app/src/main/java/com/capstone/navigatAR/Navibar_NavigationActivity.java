...
public class Navibar_NavigationActivity extends AppCompatActivity implements PermissionsListener, OnMapReadyCallback, MapboxMap.OnMapClickListener {
    private static final String TAG = Navibar_NavigationActivity.class.getSimpleName();
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        Navibar_NavigationActivity.this.mapboxMap = mapboxMap;
        mapboxMap.addOnMapClickListener(Navibar_NavigationActivity.this);
        ...
        findViewById(R.id.location_search).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new PlaceAutocomplete.IntentBuilder()
                        ...
                        .build(Navibar_NavigationActivity.this);
...
//      mapboxMap.addPolyline(new PolylineOptions().add(points).color(Color.parseColor("#3bb2d0")).width(5));
    ...
    private void getRoute(Point origin, Point destination,int profile) { // 지도상 경로 받아오기
        ...
        client.enqueueCall(new Callback<DirectionsResponse>() {
            ...
            public void onFailure(Call<DirectionsResponse> call, Throwable throwable) {
                ...
                Toast.makeText(Navibar_NavigationActivity.this, "Error: " + throwable.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    class NavigationActivityLocationCallback implements LocationEngineCallback<LocationEngineResult> {
        private final WeakReference<Navibar_NavigationActivity> activityWeakReference;
        NavigationActivityLocationCallback(Navibar_NavigationActivity activity) {
            this.activityWeakReference = new WeakReference<>(activity);
        }
        @Override
        public void onSuccess(LocationEngineResult result) {
            Navibar_NavigationActivity activity = activityWeakReference.get();
